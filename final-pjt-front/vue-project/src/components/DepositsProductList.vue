<template>
  <div>
    ...
    <h5>다음은 정기 예금 상품입니다 !</h5>
    <p>단리의 경우, 우대 단리 기준으로 정보가 제공됩니다.</p>
    <table class="table">
      <thead>
        <tr>
          <th class="name_th" scope="col">예금 상품명</th>
...
import DepositsProductListItem from '@/components/DepositsProductListItem.vue'
