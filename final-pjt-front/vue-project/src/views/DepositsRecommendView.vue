<template>
  <div class="container">
    <h1>안정을 절대적으로 추구하는 그대 !</h1>
    <h2>그대의 성향에 맞는 금융 상품은? <span class="highlight">"예금"</span></h2>
    <div class="recommendation-list">
      <DepositsRecommendList />
    </div>
  </div>
</template>
...
import DepositsRecommendList from '@/components/DepositsRecommendList.vue'

const store = useCounterStore()

onMounted(() => {
      store.depositsRecommend()
})
</script>
...
.recommendation-list li {
  ...
  color: #1d1d1f; /* 진한 회색 */
  padding: 10px 0; /* 리스트 아이템 여백 */
  border-bottom: 1px solid #e5e5ea; /* 리스트 아이템 구분선 */
}
